...
value set to the value of its corresponding original node. Both the next and random pointer of the new nodes 
...
class Clone_a_linked_list_with_next_and_random_pointer {
