...
/*
 *Write a program to implement a Stack using Array. Your task is to use
 the class as shown in the comments in the code editor and complete the
...
into the stack and pop() which returns an integer present at the top and popped out
