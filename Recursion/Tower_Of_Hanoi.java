 ...
 *The tower of Hanoi is a famous puzzle where we have three rods and N disks. The objective of the puzzle is 
 to move the entire stack to another rod. You are given the number of discs N. Initially, these discs are in the rod 1. 
...
different sizes and a bigger disc cannot be put on the top of a smaller disc. Refer the provided link to get a better clarity about the puzzle.
...
public class Tower_Of_Hanoi {
    public long toh(int N, int from, int to, int aux) {
        ...
        int res = (int) toh(N - 1, from, aux, to);
        System.out.println("move disk " + N + " from rod " + from + " to rod " + to);
        res += (int) toh(N - 1, aux, to, from);
